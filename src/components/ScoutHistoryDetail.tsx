...
import { GroupedScoutResult } from './admin/scout-history/types';
import { formatTime } from './admin/scout-history/utils';
    ...
    const detailData = groupData.items
      ...
      .flatMap(item => {
        ...
        return details.map(detail => ({
          '日付': groupData.sent_date ? new Date(groupData.sent_date).toLocaleDateString('ja-JP') : '',
