...
import { GroupedScoutResult } from './types';
...
const ScoutHistoryTable: React.FC<ScoutHistoryTableProps> = ({ paginatedResults, isLoading }) => {
  return (
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {paginatedResults.map((group) => (
                <tr key={`${group.customer_id}_${group.sent_time}`} className="hover:bg-gray-50">
